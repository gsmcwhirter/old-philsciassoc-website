5:1 - May 1999
%%%
<h1>PSA Newsletter: Vol. 5 No. 1: May 1999</h1>
...
<ol>
	<li>EDITOR'S NOTE</li>
	<li>SEARCH FOR NEW EDITOR</li>
	<li>ELECTION RESULTS</li>
	<li>PSA 2000</li>
	<li>MCDONNELL CENTENNIAL AWARDS GOES TO KATHLEEN AKINS</li>
	<li>DEBORAH MAYO WINS LAKATOS PRIZE</li>
	<li>NATIONAL SCIENCE FOUNDATION SOCIETAL DIMENSIONS PROGRAM</li>
	<li>INTEGRATING ETHICS INTO TECHNICAL EDUCATION</li>
	<li>ETHICS AND GENETICS COURSE</li>
...
<p>
As soon as a new editor for this newsletter is identified, I will resign as
editor.  I simply am not able continue this job. Thus, a search for a new
editor of this newsletter is open immediately.  If you are interested in the
position, please contact Professor George Gale, Secretary-Treasurer of the PSA.
The purpose of the newsletter is to publish information relevant to PSA members.
Issues appear as needed, but generally not more than once per month.
</p>
<hr />
<p>
3. ELECTION RESULTS
...
<p>
The next biennial meeting is meeting in Vancouver, B.C. on 4-7 November 2000.
The program Committee for PSA 2000 is as follows: Jeffrey A. Barrett
(UC Irvine), Steven M. Downes (University of Utah), Alan Hajek (Cal Tech),
Nancy J. Nersessian (Georgia Tech), John D. Norton (University of Pittsburgh),
C. Kenneth Waters (University of Minnesota), Alison Wylie (Washington University
St. Louis).
</p>
<p>
...
<p>
Members of the PSA are invited to submit proposals for symposia to be presented
at the PSA 2000.  Proposals must include sufficient supporting material to
permit the program committee to evaluate the quality and interest of the
symposium.  The proposal should include:
</p>
<ol>
	<li>The title of the proposed symposium</li>
	<li>A description of the topic and a justification of its current importance to
	the discipline (about one or two pages)</li>
	<li>Titles and abstracts of papers</li>
	<li>A list of participants and either an abbreviated curriculum vitae or a short
	biographical information file for each</li>
	<li>Addresses of each participant, with the institutional affiliation, postal and
	email addresses, and telephone numbers</li>
</ol>
<p>
...
proposals in areas where the philosophy of science engages social issues in
science or issues in science policy.
</p>
<p>
A selection of symposium papers will be published after the meeting as a
supplementary issue of Philosophy of Science.  Organizers should make it clear
to symposium participants that, normally, by accepting the invitation to
participate in a symposium they agree to present a paper at the meeting and to
deliver a final manuscript of the paper by 15 January 2001.  Symposium
organizers who wish to invite someone who would not submit a manuscript for
publication should make that status clear in the symposium proposal.
</p>
<p>
Symposium proposals should reach the chair of the Program Committee no later
than 1 November 1999.
</p>
<p>
All submissions should be directed to:
</p>
<ul class="address">
<li>Jeff Barrett, Chair</li>
<li>PSA 2000 Program Committee</li>
...
<p>
Members of the PSA are invited to submit papers to be presented at the PSA 2000
meeting in Vancouver, B.C. on 4-7 November 2000.  Contributed papers may be on
any topic in the philosophy of science, but in addition to inviting papers in
traditional areas of the philosophy of science, the Program Committee wants also
to encourage the submission of proposals in areas where the philosophy of
science engages social issues in science or issues in science policy.  The
deadline for submissions is 1 March 2000.  Some papers will be accepted for both
presentation at the PSA 2000 meeting and publication in a supplementary issue of
Philosophy of Science, other papers will be accepted just for presentation.
In each case, the Program Committee expects to make its decisions by 1 June
2000.  Final versions of all papers accepted for publication must be submitted
by 15 January 2001.
</p>
<p>
Continuing with the tradition established for the sixteenth-biennial meeting,
...
<p>
The maximum recommended manuscript length is 5,000 words, including footnotes
and references.  If the text includes tables or figures, an appropriate number
...
those of the journal, Philosophy of Science (see a recent issue for details).
Since papers will be blind refereed, the author's name, institutional
affiliation, surface and email addresses, and telephone number(s) should appear
only on a separate cover letter or cover sheet.  Submissions will be accepted in
...
papers, with a time limit of approximately twenty minutes (plus discussion).
</p>
<hr />
<p>
...
<ol>
<li>Scholars Awards enable individuals to undertake full time research
...
maximum award is $120,000, expected to extend over 24 months</li>
<li>Grants for collaborative research, infrastructure or education projects.
...
national organization or professional society is sponsoring the meeting.</li>
<li>Doctoral Dissertation Research Improvement Grants provide funds for
...
research in North America and $12,000 for work abroad.</li>
<li>Post-Doctoral and Professional Development Fellowships, undertaken with
...
institution allowance.</li>
<li>Small Grants for Training and Research are awards to senior investigators
...
allowed; the maximum award is $100,000 yearly.</li>
...
<p>
Ethics and Genetics: Advanced European Bioethics Course. 18-20 November 1999,
Nijmegen, the Netherlands.  Specialists from various countries will discuss
ethical aspects of genetics.  Subjects: ethics and the Human Genome Project;
genetic counselling; genetic screening; human gene therapy; geneticization.
Lecturers: H. Brunner (Netherlands), A. Clarke (United Kingdom), D. Gracia
(Spain), A. Lippman (Canada), P. Schotsmans (Belgium).  All lectures and plenary
sessions will be held in English.  Course fee: Dfl. 575.  For more information:
...
<p>
The issue can be overprinted, and made available (USD20) to non-subscribers
through the International History, Philosophy and Science Teaching Group.
To facilitate this arrangement, orders need to be placed prior to printing
</p>
<pre>
ORDER FORM: SCIENCE &amp; EDUCATION, VOL.8 NO.2
GALILEO AND SCIENCE EDUCATION
...
ENCLOSED: CHEQUE or CREDIT CARD DETAILS
(Cheques to Science &amp;  Education)

AMOUNT: US$20 (single copy), US$15 (multiple copies),
or AUS$30 (single copy), $22 (mult.)
...
AMOUNT: US$60 (1 year), $115 (2 years), $165 (3 years);
or AUD$90, $180, $2500; or UK=A340, =A376, =A3110
(please circle one; multiple-year subscriptions are encouraged
as this reduces mailing and banking fees, and administrative time)
