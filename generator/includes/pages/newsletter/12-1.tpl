12:1 - February 2006
%%%
<h1>PSA Newsletter: Vol. 12 No. 1: February 2006</h1>
...
<li>POSTDOC in philosophy of biology, Center for Philosophy and Ethics of Science
(ZEWW),
...
<li>CALL for PAPERS: Models and Simulations Conference, Paris, 12-13 June 2006.
 Deadline, March 15, 2006.</li>
<li>JOB: Department of Philosophy, the University of Duesseldorf, Germany.
 Deadline: Feb. 20, 2006.</li>

<li>CALL for PAPERS: Ashgate Companion to Contemporary Philosophy of Biology.
 Deadline: May 15, 2006.</li>

<li>HPSM LISTSERV: Covering the History and Philosophy of Science in the
Northeast of
 England.</li>

<li>2006 SUMMER SYMPOSIUM of the International Society for the Philosophy of
Chemistry
 (ISPC 10), Split, Croatia, August 6
- 10, 2006. Registration deadline: June 1, 2006.</li>
...
<ol>
<li>What difference does the essentially dynamic nature of simulations make to
modeling, particularly in their representational abilities?</li>
<li>Is there a difference between simulations that have an explicit model or
theory behind them and those that do not?</li>
<li>When there is no model, what form does the representational connection
between the simulation and the world take?</li>
<li>Can any sense be made of claims that the world itself is carrying out
computations and simulating itself?</li>
<li>What role does intentionality play in simulations or such apparently
automatic representational processes as genetic algorithms?</li>
<li>Are there principles that one can use to decide whether a simulation is to be
interpreted realistically or only instrumentally?</li>
<li>At what level (e.g. the machine code, the algorithmic, the scientific
language) does a simulation represent a system?</li>
<li>It is well-known hat models enter into different relationships such as
isomorphism, embedding, or being a submodel of. Are there analogous relations
between simulations?</li>
<li>What would qualify as an equivalence relation between simulations?</li>
<li>What is the relation between simulations used as an experimental tool and
real experiments?</li>
<li>How does the methodology of simulations compare with experimentation?</li>
<li>How, if at all, do models and simulations explain?</li>
<li>What are the implications of the growing use of simulations in science for
our understanding of science?</li>
<li>What are the implications of the repeated use of the same models and
simulations within different fields of science?</li>
<li>How reliable are the results of simulations, and how is the reliability of a
simulation determined?</li>
<li>What role does mathematics play in simulations?</li>
<li>Is there a difference between the use of simulations across different fields
such as physics, biology, and the social sciences?</li>
<li>Is there a difference between the use of simulations in fundamental science
and in applied science?</li>
</ol>
<p>
...
<ul class="address">
<li>Professor Dr. Gerhard Schurz, Chair of Theoretical Philosophy,</li>
<li>Department of Philosophy,</li>
<li>University of Duesseldorf,</li>
<li>Universitaetsstrasse 1, Gebaeude 23.21,</li>
<li>D-40225 Duesseldorf. Germany.</li>
</ul>
<p>
For more information contact:
</p>
<ul class="address">
<li class="email">E-Mail: gerhard.schurz@phil-fak.uni-duesseldorf.de.</li>
<li class="phone">Phone: +49 - 211) 811-5763</li>
<li class="website">Homepage: www.phil-fak.uni-duesseldorf.de/thphil</li>
</ul>
<p>
...
1.2. Origin and Biological Relevance of
...
<ul>
<li>Sunday afternoon: Registration and opening reception.</li>
<li>Monday: Opening plenary session, contributed papers.</li>
<li>Tuesday: Plenary session, contributed papers.</li>
<li>Wednesday: Plenary session, contributed papers, conference Banquet.</li>
<li>Thursday: Closing session, executive committee meeting. Departure.</li>
</ul>
<p>
