...
<ol>
	<li>EDITOR'S NOTE</li>
	<li>Philosophy of Science Syllabus Sampler</li>
	<li>Mellon Postdoctoral Fellowship in History of Science</li>
	<li>Mellon Fellowships for Assistant Professors</li>
	<li>Dubrovnik Philosophy of Science Conference</li>
	<li>Conference on Naturalism, Theism and the Scientific Enterprise</li>
	<li>Computing and Philosophy Conference</li>
	<li>Medicine and Health Care Conference</li>
	<li>Conference on Unscientific Psychology</li>
	<li>New Ph.D. Programme in Philosophy and Economics</li>
</ol>
<hr />
<p>
...
<ul>
        <li>General Survey I:  Metaphysics &amp; Core Concepts</li>
        <li>General Survey II:  Science Studies Orientation</li>
        <li>Race, Gender and Science</li>
        <li>Philosophy of Biology</li>
        <li>Philosophy of Physics</li>
        <li>Philosophy of Psychology &amp; the Social Sciences</li>
...
<ol>
        <li>description of the course's primary objectives and/or its
		framework and main themes</li>
        <li>topic outline and weekly schedule</li>
        <li>complete reading list (with full citations)</li>
        <li>instructor's name, institution, address, and phone or e-mail</li>
</ol>
<p>
...
<ul class="address">
	<li>James Robert Brown</li>
	<li>Department of Philosophy</li>
	<li>University of Toronto</li>
	<li>Toronto, Ontario</li>
	<li>CANADA     M5S 1A1</li>
...
<ul>
	<li>Michael Ruse (Philosophy, University of Guelph, author of Darwinism Defended)</li>
	<li>Alvin Plantinga (Philosophy, University of Notre Dame, author of Warrant
	and Proper Function)</li>
	<li>Frederick Grinnell (UT Southwestern Medical Center, author of The
	Scientific Attitude)</li>
	<li>Philip Johnson (Law School, UC-Berkeley, author of Darwin on Trial and
	Reason in the Balance).</li>
</ul>
<p>
...
<p>
Unscientific Psychology: Conversations With Other Voices<br />
...
<p>
June 14-15, 1997<br />
Edith Macy Conference Center<br />
...
understanding human life as semergent, activisitic, relational and
performatory.
</p>
<p>
...
<p>
Costs: Conference registration: $100<br />
...
<ul class="address">
	<li>East Side Institute</li>
	<li>500 Greenwich Street</li>
...
<ul class="address">
	<li>Erasmus Institute of Philosophy and Economics</li>
	<li>att. dr Albert Jolink</li>
