11:4 - November 2005
%%%
<h1>PSA Newsletter: Vol. 11 No. 4: November 2005</h1>
<p style="display: none;">
***************************************************************


PSA Newsletter: Volume 11 : Number 4: November 2005
...
<ul>
<li>Horacio Arlo-Costa (Carnegie Mellon University)</li>
<li>Brad Armendt (Arizona State University)</li>
<li>Robert Batterman (Ohio State University)</li>
<li>William Bechtel (University of California, San Diego)</li>
<li>Craig Callender (University of California, San Diego)</li>
<li>David Christensen (University of Vermont)</li>
<li>John Dupre (University of Exeter)</li>
<li>Branden Fitelson (University of California, Berkeley)</li>
<li>Patrick Grim (SUNY, Stony Brook)</li>
<li>Francesco Guala (University of Exeter)</li>
<li>Hans Halvorson (Princeton University)</li>
<li>William Harper (University of Western Ontario)</li>
<li>Stephan Hartmann (London School of Economics)</li>
<li>Gary Hatfield (University of Pennsylvania)</li>
<li>Alan Hájek (The Australian National University)</li>
<li>Nicholas Huggett (University of Illinois at Chicago)</li>
<li>Kevin Kelly (Carnegie Mellon University)</li>
<li>Noretta Koertge (Indiana University)</li>
<li>Elisabeth Lloyd (Indiana University)</li>
<li>Penelope Maddy (University of California, Irvine)</li>
<li>Deborah Mayo (Virginia Tech)</li>
<li>Ned McClennen (Syracuse University)</li>
<li>Wayne Myrvold (University of Western Ontario)</li>
<li>John Norton (University of Pittsburgh)</li>
<li>Samir Okasha (University of Bristol)</li>
<li>David Papineau (King¹s College, London)</li>
<li>Wlodek Rabinowicz (Lund University)</li>
<li>Alex Rosenberg (Duke University)</li>
<li>Sherri Roush (Rice University)</li>
<li>Sahotra Sarkar (University of Texas, Austin)</li>
<li>Kristin Shrader-Frechette (University of Notre Dame)</li>
<li>Wolfgang Spohn (University of Konstanz)</li>
<li>Paul Weirich (University of Missouri)</li>
<li>Michael Weisberg (University of Pennsylvania)</li>
<li>Scott Weinstein (University of Pennsylvania)</li>
</ul>
<p>
...
<p>
Geoffrey Brennan (Duke University, USA)<br />
...
<ul>
<li>The economic approach to ethics.</li>
<li>Discounting the future.</li>
<li>Rational choice from a participant's and from the objective point of view.</li>
<li>Arrow and the economic approach.</li>
<li>Sen and Coase.</li>
<li>Trust, its role and its evolution.</li>
<li>Economising on virtue.</li>
<li>The economy of virtue.</li>
<li>David Hume's theory of government.</li>
<li>Esteem: conceptual and analytic.</li>
<li>No theory of justice.</li>
<li>Expressive voting</li>
<li>Public and private responsibility in health care and the limits of state action.</li>
</ul>
<p>
...
<li>A one-page statement (in English), briefly outlining your previous work and your
reason for attending the VISU-SWC.</li>
<li>A (sealed) letter of recommendation from your professor, including some comment
on your previous work. This letter may also be sent directly by your professor.</li>
...
<li>c/o Institute Vienna Circle</li>
<li>University Campus, Spitalgasse 2-4, Court 1, A-1090</li>
