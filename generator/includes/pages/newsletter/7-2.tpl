7:2 - May 2001
%%%
<h1>PSA Newsletter: Vol. 7 No. 2: May 2001</h1>
...
<ol>
	<li>Wesley C. Salmon</li>
	<li>PSA 2002: Call for Symposium Proposals and Workshop Proposals</li>
	<li>PSA 2002: Call for Papers</li>
	<li>PROGRAM COMMITTEE for PSA 2002</li>
	<li>NEW: PHILSCI ARCHIVE</li>
	<li>NEW JOURNAL: Semiotics, Evolution, Energy, Development</li>
	<li>WORKSHOP ON QUANTUM GRAVITY, July 4, 2001</li>
	<li>REASON PARK: Deadline May 15th, 2001</li>
	<li>RESOURCES in History and Philosophy of Science</li>
</ol>
<p>
   ENDNOTES:
</p>
...
<ol>
	...
	<li>A description of the topic and a justification of its current importance
  to the discipline (about one or two pages).</li>
	<li>Titles and abstracts of papers.</li>
	<li>A list of participants and either an abbreviated curriculum vitae or
  short biographical information file for each.</li>
	<li>Addresses of each participant, with the institutional affiliation, postal
  and email addresses, and telephone numbers.</li>
</ol>
<p>
...
<ul>
  <li>New type of session - the workshop;</li>
  <li>Web archiving of papers prior to meeting.</li>
</ul>
<p>
...
<ol>
	...
	<li>Your surface address,</li>
	<li>Your email address,</li>
	<li>Your telephone number,</li>
	<li>The 100-word abstract.</li>
</ol>
<p>
...
<ul>
  ...
  <li>Harvey R. Brown (University of Oxford)</li>
  <li>Craig Callender (University of California, San Diego)</li>
  <li>Malcolm Forster (University of Wisconsin, Madison)</li>
  <li>Helen Longino (University of Minnesota)</li>
  <li>Mohan Matthen (University of British Columbia)</li>
  <li>Sandra D. Mitchell (University of Pittsburgh), Chair</li>
  <li>Alexander Rosenberg (Duke University)</li>
</ul>
<p>
...
<ul class="address">
  ...
  <li>PSA 2002 Program Committee</li>
