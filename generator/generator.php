...
if(strtolower($_SERVER["REQUEST_METHOD"]) == "post")
{
	try{
		...
		$settings->content_file_path = $path."/includes/";
		$settings->link_prefix_testing = "/generator/output/testing/";
		$settings->link_prefix_final = "/generator/target/";
		...
		$settings->domain_prefix = "http://www.hallofkvasir.org";
		$settings->rss_file = "news.rss";
		$settings->rss_title = "Philosophy of Science Association News";
		$settings->rss_description = "";
		$settings->webmaster = "philsci.webmaster@gmail.com";
		$settings->analytics_id = "UA-10966779-2"; //"UA-10966779-1"
		$settings->google_verify = "dYMzdN7-m4SN-XPQnSJTpB9d7-2y-Zb49CKag-YmIuA";
